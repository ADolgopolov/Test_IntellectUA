...
function initWriter(a) {
	...
	showMsgStatusBar("&nbsp;");
	if (0 == workDicArray.length) document.getElementById("topheader").innerHTML = str_Rest_and_try_late, QuestionBtn.innerHTML = str_Fine, QuestionBtn.disabled = !0, QuestionBtn.parentElement.disabled = !0, PrinterDiv.innerHTML = "", StatusBar.innerHTML = str_All_tsks_done, ProgressBar.style.width = "100%", ProgressBar.innerHTML = "", MarkRuler.style.display = "block";
	else {
